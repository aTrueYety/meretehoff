...
<div>
      ...
      <div style="display: flex; flex-direction: row; gap: 1rem;">
        <?php foreach ($images as $image): ?>
          <div style="display: flex; flex-direction: column; align-items: center;">
            <img src="../uploads/<?= htmlspecialchars($image['file_path']) ?>" alt="Utstillingsbilde" style="max-width: 200px; max-height: 200px;">      
            <button type="submit" name="delete_image_id" value="<?= htmlspecialchars($image['position']) ?>" style="width: 100%;">Slett</button>
          </div>
        <?php endforeach; ?>
      </div>
    </form>
    ...
    <form method="post">
      ...
      <a href="../index.php#exhibitions-anchor">Avbryt</a>
    </form>
  </div>
    <?php endif; ?>
</div>
